...
borabora = Island.create!(user: User.first, name: 'Bora Bora2', description: 'It is so romantic', price: 10000000, type_of_event: "Wedding party", capacity: 35, address: "Bora Bora")
...
goa = Island.create!(user: laura, name: 'Chorao', description: 'Goa parties, get colorful, get psyched!', price: 5000000, type_of_event: "Goa party", capacity: 200, address: "Chorao")
goa.photos.attach([{io: file4, filename: 'goa.jpg', content_type: 'image/jpg'}, {io: file3, filename: 'goaparty.jpg', content_type: 'image/jpg'}])
...
sanmiguel = Island.create!(user: laura, name: 'San Miguel', description: 'Party in the nature, no one will bother you', price: 10000000, type_of_event: "Birthday party", capacity: 50, address: "San Miguel, Azores")
...
krong = Island.create!(user: ricky, name: 'Koh Rong', description: 'Dance your feet off under the moon', price: 8000000, type_of_event: "Full moon party", capacity: 300, address: "Koh Rong")
...
isla = Island.create!(user: ricky, name: 'Isla Providencia', description: 'Come for an unforgettable stag night with your best bros', price: 50000000, type_of_event: "Stag party", capacity: 50, address: "Isla de la Providencia")
...
yap = Island.create!(user: ricky, name: 'Yap Island', description: 'Rave in paradise!', price: 1000000000, type_of_event: "Techno party", capacity: 500, address: "Yap, Micronesia")
...
azura = Island.create!(user: ricky, name: 'Azura', description: 'say YES in heaven', price: 1000000000, type_of_event: "Wedding party", capacity: 200, address: "Ilha de Benguerra")
...
corvo = Island.create!(user: peter, name: 'Corvo Island', description: 'Psytrance and a vulcano? Say no more!', price: 800000, type_of_event: "Goa party", capacity: 100, address: "Corvo, Azores")
...
fula = Island.create!(user: peter, name: 'Foula Island', description: 'Party like a Viking', price: 8000000, type_of_event: "Stag party", capacity: 40, address: "Foula, Scotland")
...
mindoro = Island.create!(user: peter, name: 'Mindoro', description: 'All the single ladies welcome!', price: 90000000, type_of_event: "Bachelorette party", capacity: 65, address: "Mindoro")
