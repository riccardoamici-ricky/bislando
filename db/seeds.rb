...
borabora = Island.create!(user: laura, name: 'Bora Bora', description: 'It is so romantic... Come and fall in love forever, if not with someone, with this beautiful island. A welcome cocktail is included in the price.', price: 10000000, type_of_event: "Wedding party", capacity: 35, address: "Bora Bora, French Polynesia")
...
insel = Island.create!(user: laura, name: 'Insel Lindweder', description: "We've got the best sound-system for your Techno parties! But our island is no-frills, bring your camping gear and don't forget to stay hydrated.", price: 5000, type_of_event: "Techno party", capacity: 100, address: "Berlin, Germany")
